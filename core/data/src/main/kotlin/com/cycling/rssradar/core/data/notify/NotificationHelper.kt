...
object NotificationHelper {
    ...
    fun postNewArticles(context: Context, summary: NewArticleSummary.Summary): Boolean {
        ...
        // 通知点击回到主界面。core:data 不依赖 app 模块（拿不到 MainActivity 类），
        // 按包名显式指向 <applicationId>.MainActivity，行为与 Intent(context, MainActivity) 等价。
        val intent = Intent().setClassName(context.packageName, "${context.packageName}.MainActivity").apply {
